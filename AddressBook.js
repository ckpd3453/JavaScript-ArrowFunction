 ...
 //Ability to Delete the  Contact From Address Book
 ...
 // Ability to Count Total Number Of Contact 
 ...
 //Ability to Search Contact from AddressBook 
 ...
 // Ability to Count Contact From Perticuler City Or State
 ...
 function selectFunction(select) {
     switch (select) {
         case "contactDetails":
             ...
             contactDetails("Chandraant", "Prasad", "RlyColony", "Jharkhand", "Bokaro", "827010", "chandra@gmail.com", "7009150698");
             contactDetails("Anand", "Singh", "Kadma", "Jharkhand", "Jamshedpur", "527852", "anand@gmail.com", "8725495610");

             // added contact for duplicate entry

             contactDetails("ChandraKant", "Prasad", "RlyColony", "Jharkhand", "Bokaro", "827010", "chandra@gmail.com", "7009150698");

             contactDetails("Aman", "Patel", "Rajbandh", "WestBengal", "Durgapur", "427879", "aman@gmail.com", "7748695248");
         ...
         case "searchByCity_State":
             ...
             searchByCity_State("state", "WestBengal");
             break;
         ...
         case "countContactInCity_State":
             ...
             countContactInCity_State("state", "Jharkhand");
             countContactInCity_State("city", "Bokaro");
             break;
         case "sortContact":
